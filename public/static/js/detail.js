...
IntroduceFn.prototype = {
    ...
    isWxbind: function(){
        var mask = $('<div class="mask"></div>')
            ...
            code_bg = $('<div class="code-bg"><iframe id="childframe" src="http://home.51cto.com/get-iframe-qr-code" iframeboder="0" scrolling="no" allowtransparency="true" style="border: 0 none;margin: 8px 14px;" width="120" height="120" name=""></iframe></div>')
