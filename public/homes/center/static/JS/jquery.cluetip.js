...
// close cluetip and reset some things
  ...
  $.fn.cluetip.defaults = {  // set up default options
    ...
    cluezIndex:       107,       // Sets the z-index style property of the clueTip
    ...
    closeText:        '&times;',  // text (or HTML) to to be clicked to close sticky clueTips
