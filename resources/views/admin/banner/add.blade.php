...
<div class="col-lg-10">
    <div class="card">
        ...
        <form action="/admin/banner" method="post" enctype="multipart/form-data" class="form-horizontal">
        	<div class="card-body card-block">
                <div class="row form-group">
                    ...
                    <div class="col-12 col-md-7">
                    	<input type="text" id="text-input" name="title" placeholder="请输入标题" class="form-control">
                    </div>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-12 col-md-7">
                    	<input type="text" id="text-input" name="link" placeholder="请输入地址" class="form-control">
                    </div>
                </div>
                <div class="row form-group">
                    <div class="col col-md-2" style="text-align:center; line-height: 38px">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-12 col-md-7">
                        <select name="status" id="select" class="form-control">
                            <option value="0"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">显示</font></font></option>
                            <option value="1"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">隐藏</font></font></option>
                        </select>
                    </div>
                </div>
        	</div>
