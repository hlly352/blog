...
<div class="col-lg-10">
    <div class="card">
        ...
        <form action="/admin/permission" method="post" class="form-horizontal">
            <div class="card-body card-block">
                <div class="row form-group">
                    ...
                    <div class="col-12 col-md-7">
                        <input type="text" id="text-input" name="pername" placeholder="请输入权限名" class="form-control">
                    </div>
                </div>
                <div class="row form-group">
                    <div class="col col-md-2" style="text-align:center; line-height: 38px">
                    ...
                    <div class="col-12 col-md-7">
                        <input type="text" id="text-input" name="perurl" class="form-control">
                    </div>
                </div>      
            </div>
