...
<div class="col-lg-10">
    <div class="card">
        ...
        <form action="/admin/role/{{$res->id}}" method="post" class="form-horizontal">
            <div class="card-body card-block">
                <div class="row form-group">
                    ...
                    <div class="col-12 col-md-7">
                        <input type="text" id="text-input" name="rolename" placeholder="请输入角色名" class="form-control" value="{{$res->rolename}}">
                    </div>
                </div>     
            </div>
