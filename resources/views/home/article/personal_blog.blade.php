...
<div class="Content-box">
        ...
        <div class="header-top">
          <div class="is-vip-bg-2 fl">
            <a href="javascript:;" class="a-img">
              <img class="is-vip-img is-vip-img-1" data-uid="14169969" src="{{$img}}"/>
            </a>
          </div>
          <div class="right">
      ...
      <div class="Page blog-my">
        ...
        <div class="Left" id="Tab">
          ...
          <ul class="blog-my-title">
            <li class="on"><a href="/home/pubart?uid={{$authorid}}">全部</a></li>
            @foreach($mytype as $k=>$v)
            <li class="on"><a href="/home/pubart?person={{$v->name}}&uid={{$authorid}}">{{$v->name}}</a></li>
            @endforeach
            <div class="clear"></div>
          </ul>
                ...
                <div class="top ">
                  <div class="is-vip-bg fl">
                    ...
                    <a href="" class="a-img" target="_blank">
                      <img class="avatar is-vip-img is-vip-img-4" data-uid="14169965" src="{{$img}}">
                    </a>
                  </div>
                  <a href="#" return false class="name fl">{{$val->author}}</a>
  ...
  <div class="page">
            {{$rs->appends(['person'=>(isset($_GET['person']))?$_GET['person']:'','uid'=>(isset($_GET['uid']))?$_GET['uid']:''])->links()}}          
          </div>
